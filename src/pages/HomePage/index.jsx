...
export default function HomePage({ apiBaseUrl }) {
    ...
    return (
        <div>
            <div>
                <h1 className="mb-1 md:mb-4 px-1 bg-emerald-600 text-white font-bold md:text-2xl rounded">What is My Bird List?</h1>
            ...
            <h2 className="px-1 font-bold md:text-xl bg-emerald-600 text-white rounded">Recent user sightings</h2>
