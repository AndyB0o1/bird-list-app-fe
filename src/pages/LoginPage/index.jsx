...
export default function LoginPage() {
    ...
    return (
        <>
            <h1 className="mt-4 p-2 bg-amber-500 text-amber-950">Login below to see your list</h1>
            <form onSubmit={handleLogin}>
                <div className="my-1 flex gap-2 text-amber-950">
                ...
                <button className="p-1 my-2 bg-amber-500 text-amber-950 rounded" type="submit">Login</button>
            </form>
        </>
    )
}