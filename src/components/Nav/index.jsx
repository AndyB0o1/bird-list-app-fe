...
export default function Nav() {
    ...
    return (
        <div className="h-32 md:h-48 mb-2 p-1.5 sm:p-4 bg-[url('/murmurationmobile.jpeg')] sm:bg-[url('/murmuration.jpeg')] text-white">
            ...
            <h2 className="p-1 text-sm md:text-lg">Keep your life list of birds in one easy to manage place</h2>
            <div className="p-1 md:mt-4 flex gap-x-1 md:gap-x-2 text-xs md:text-base">
